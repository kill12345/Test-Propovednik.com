...
public class AudioPlayer {
	...
	By playButtonXpath = By.xpath("//*[@id='jp_container_1']/div/div[1]/div[3]/button[2]");
	By locator = By.xpath("//button[@class='jp-repeat-off light-grey-style animated']");
	
	public boolean isPlayButtonPresent(WebDriver driver) {
		boolean PlayButtonPresent;

		try {
			driver.findElement(playButtonXpath);
	...
	public void clickPlayButton(WebDriver driver) {
		WebElement playButton = driver.findElement(playButtonXpath);
		playButton.click();
	}
	...
	public void clickPauseButton(WebDriver driver) {
		WebElement enablePauseButton = driver
				.findElement(By.xpath("//*[@id='jp_container_1']/div/div[1]/div[3]/button[1]"));
	...
	public void clickDisableVolumeButton(WebDriver driver) {
		WebElement DisableVolumeButton = driver
				.findElement(By.xpath("//button[@class='light-grey-style animated jp-mute']"));
