...
//	}
	...
	public List<String> getAllTracksFromPlaylist(WebDriver driver) {
		List<WebElement> allTracksLiElements = driver.findElements(By.xpath("//ul[@id='playlist-ul']/li/div/a[2]"));
		
		List<String> allTracks = new ArrayList<String>();
		for(WebElement li:allTracksLiElements){
			String liText = li.getText().trim();
			allTracks.add(liText);
		}
